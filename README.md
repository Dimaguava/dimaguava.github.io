...
На данный момент <b> инструментарий <b> включает струнные и ударные инструменты, флейты и другие духовые, Ableton 12 и midi контроллеры, iPad с виртуальными модулярами (miRack/Vcv), diy синтезаторы, микрофоны, эффекты, circuit bend системы, zero input, радио и кассетные плееры (в т. ч. tape loop), field recording и др.<br>
